...
const cardSurface =
  "rounded-3xl border border-slate-100/50 bg-card text-card-foreground shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]";
...
const CardDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-sm tracking-wide text-slate-500", className)} {...props} />
  ),
);
